...
class Security(BaseAGSServer):
    ...
    def assignPrivilege(self, rolename, privilege="ACCESS"):
        """
           ...
           tiers of privileges:
               ADMINISTERA role that possesses this privilege has 
                          unrestricted administrative access to ArcGIS 
                          Server.
               PUBLISHA role with PUBLISH privilege can only publish GIS 
                       services to ArcGIS Server.
               ACCESSNo administrative access. A role with this privilege 
