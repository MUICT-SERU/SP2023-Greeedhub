...
#             writer.writerow(['URL', 'ProjectName', 'Path', 'Status'])
#             next(reader)  # Skip the header row in DataPyPI.csv
#             for row in reader:
#                 url, project_name = row[0], row[1]
#                 path = f'../PythonFiles_keep/{project_name}'
...
#         writer = csv.DictWriter(done_file, fieldnames=['URL', 'ProjectName', 'Path', 'Status'])
#         writer.writeheader()  # Write header

#     with open('../all_projects_undone.csv', 'w', newline='', encoding='utf-8') as undone_file:
#         writer = csv.DictWriter(undone_file, fieldnames=['URL', 'ProjectName', 'Path', 'Status'])
#         writer.writeheader()  # Write header

#     # Append new records to all_projects_done.csv and all_projects_undone.csv
#     done_projects = []
#     undone_projects = []
#     fieldnames = ['URL', 'ProjectName', 'Path', 'Status', 'DeadAliveStatus']  # Updated fieldnames
...
#         writer = csv.DictWriter(done_file, fieldnames=fieldnames)
#         if done_projects:
...
#         writer = csv.DictWriter(undone_file, fieldnames=fieldnames)
#         if undone_projects:
...
#             project_path = os.path.join('../PythonFiles_keep', project_name).replace("\\", "/")
...
#     if done_count_dup - done_count == 1 or undone_count_dup - undone_count == 1:
#         print("\n==============================================================")
#         print("==============================================================\n")
#         print(f"Number of successfully recorded projects: {done_count}")
#         print(f"Number of unsuccessfully recorded projects: {undone_count}")
