...
class ModflowSwt(Package):
    ...
    iswtcb : int
        iswtcb is a flag and unit number to which cell-by-cell flow terms will
    ...
    def __init__(self, model, iswtcb=0, iswtoc=0, nsystm=1, ithk=0, ivoid=0, istpcs=1, icrcc=0,
    ...
    def __repr__(self):
        return 'Subsidence and Aquifer-System Compaction Package for Water-Table Aquifers (SUB-WT) package class'
    ...
    def write_file(self):
        ...
        f.write('{}\n'.format(self.heading))
        # write dataset 1
        f.write('{} {} {} {} {} {} {}\n'.format(self.iswtcb, self.iswtoc, self.nsystm, self.ithk,
    ...
    def load(f, model, ext_unit_dict=None):
        ...
        t = line.strip().split()
        iswtcb, iswtoc, nsystm, ithk, ivoid, istpcs, icrcc = int(t[0]), int(t[1]), int(t[2]), int(t[3]), \
        ...
        swt = ModflowSwt(model, iswtcb=iswtcb, iswtoc=iswtoc, nsystm=nsystm, ithk=ithk, ivoid=ivoid, istpcs=istpcs,
