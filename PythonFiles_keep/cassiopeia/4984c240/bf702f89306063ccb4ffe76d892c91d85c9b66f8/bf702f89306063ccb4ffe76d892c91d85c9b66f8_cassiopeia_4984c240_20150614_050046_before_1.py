...
def get_leagues_by_summoner_id(ids):
...
# @param ids # cassiopeia.type.core.summoner.Summoner # The summoner(s) to get leagues for
# @return # list<list<cassiopeia.type.core.league.League>> or list<cassiopeia.type.core.league.League> # The leagues for the requested summoner(s)
def get_leagues_by_summoner(summoners):
    if(isinstance(summoners, list)):
        return get_leagues_by_summoner_id([summoner.id for summoner in summoners])
    else:
        return get_leagues_by_summoner_id(summoners.id)
...
def get_league_entries_by_summoner_id(ids):
...
# @param ids # cassiopeia.type.core.summoner.Summoner # The summoner(s) to get league entries for
# @return # list<list<cassiopeia.type.core.league.League>> or list<cassiopeia.type.core.league.League> # The league entries for the requested summoner(s)
def get_league_entries_by_summoner(summoners):
    if(isinstance(summoners, list)):
        return get_league_entries_by_summoner_id([summoner.id for summoner in summoners])
    else:
        return get_league_entries_by_summoner_id(summoners.id)
...
def get_leagues_by_team_id(ids):
...
# @param ids # cassiopeia.type.core.team.Team # The team(s) to get leagues for
# @return # list<list<cassiopeia.type.core.league.League>> or list<cassiopeia.type.core.league.League> # The leagues for the requested team(s)
def get_leagues_by_team(teams):
    if(isinstance(teams, list)):
        return get_leagues_by_team_id([team.id for team in teams])
    else:
        return get_leagues_by_team_id(teams.id)
...
def get_league_entries_by_team_id(ids):
...
# @param ids # cassiopeia.type.core.team.Team # The team(s) to get league entries for
# @return # list<list<cassiopeia.type.core.league.League>> or list<cassiopeia.type.core.league.League> # The league entries for the requested team(s)
def get_league_entries_by_team(teams):
    if(isinstance(teams, list)):
        return get_league_entries_by_team_id([team.id for team in teams])
    else:
        return get_league_entries_by_team_id(teams.id)