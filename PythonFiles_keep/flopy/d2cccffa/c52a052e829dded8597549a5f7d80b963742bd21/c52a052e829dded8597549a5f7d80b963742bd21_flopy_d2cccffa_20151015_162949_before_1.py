...
class check:
    ...
    def elevations(self):
        ...
        if self.sfr.nstrm < 0 or self.sfr.reachinput and self.sfr.isfropt in [1, 2, 3]:  # see SFR input instructions
            ...
            if self.sfr.reach_data.outreach.max() == 0:
            ...
            recfunctions.append_fields(reach_data, names='strtopdn', data=outreach_elevdn)
        ...
        if self.sfr.nstrm < 0 or self.sfr.reachinput and self.sfr.isfropt in [1, 2, 3]:  # see SFR input instructions
            ...
            recfunctions.append_fields(reach_data, names='layerbot', data=bots)
