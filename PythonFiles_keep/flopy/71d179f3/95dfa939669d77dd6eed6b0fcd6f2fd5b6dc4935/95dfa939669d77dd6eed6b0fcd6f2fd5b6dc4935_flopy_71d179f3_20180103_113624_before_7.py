...
class ModflowGwfdrn(mfpackage.MFPackage):
    ...
    obs_filerecord : [obs6_filename]
        * obs6_filename (string) name of input file to define observations for
        ...
        obstype lists observation type(s) supported by the Drain
        package.
    mover : boolean
    ...
    periodrecarray : [cellid, elev, cond, aux, boundname]
        ...
        * aux (double) represents the values of the auxiliary variables for
        each drain. The values of auxiliary variables must be present for each
        drain. The values must be specified in the order of the auxiliary
