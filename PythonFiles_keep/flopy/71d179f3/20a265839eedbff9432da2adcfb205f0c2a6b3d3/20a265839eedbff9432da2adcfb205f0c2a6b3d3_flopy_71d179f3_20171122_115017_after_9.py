...
class ModflowGwfevta(mfpackage.MFPackage):
    ...
    ievt : [(ievt : integer)]
        ievt : ievt is the layer number that defines the layer in each vertical column where evapotranspiration is applied. If ievt is omitted, evapotranspiration by default is applied to cells in layer 1.
