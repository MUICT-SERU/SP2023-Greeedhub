...
class ModflowDrn(Package):
    ...
    def __init__(self, model, idrncb = 0, layer_row_column_data=None,
                 ...
                 extension ='drn', unitnumber=21, options=None, naux=0, zerobase=True):
        ...
        self.mxactd, self.layer_row_column_data = self.assign_layer_row_column_data(layer_row_column_data,
                                                                                    5+naux, zerobase=zerobase)
        self.np = 0
        if options is None:
            options = []
