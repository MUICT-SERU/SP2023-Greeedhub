...
class ModflowSwi(Package):
    ...
    def __init__(self, model, npln=1, istrat=1, iswizt=None, nprn=1,
                 toeslope=0.05, tipslope=0.05, zetamin=0.005, delzeta=0.05,
                 nu=0.025, zeta=[], ssz=[], isource=0,
                 extension=['swi', 'zta'], unitnumber=None):
        """
        Package constructor.
        ...
        if iswizt is not None:
            fname = None
            model.add_output_file(iswizt, fname=fname, ext=extension[1],
                                  package=ModflowSwi.ftype())
        else:
            iswizt = 0

        name = [ModflowSwi.ftype()]
        extra = ['']
    ...
    def write_file(self):
        ...
        self.parent.write_array_old(f_swi, self.nu, self.unit_number[0], True,
                                    13, 20)
    ...
    def load(f, model, ext_unit_dict=None):
        ...
        print(
            '   Warning: load method not completed. default swi object created.')
