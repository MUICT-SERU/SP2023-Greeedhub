...
class ModflowMvr(mfpackage.MFPackage):
    ...
    periodrecarray : [(mname1 : string), (pname1 : string), (id1 : integer), (mname2 : string), (pname2 : string), (id2 : integer), (mvrtype : string), (value : double)]
    ...
    def __init__(self, simulation, add_to_package_list=True, print_input=None, print_flows=None, modelnames=None,
        ...
        super(ModflowMvr, self).__init__(simulation, "mvr", fname, pname, add_to_package_list, parent_file)        
        ...
        self.packagesrecarray = self.build_mfdata("packagesrecarray", packagesrecarray)
