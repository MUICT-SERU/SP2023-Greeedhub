...
directory_path = r"C:\Users\Oily_brd\Desktop\Greeedhub\visualization_difference\CompetencyScore_Dead\aiohttp-route-middleware"  # Replace with your actual directory path
