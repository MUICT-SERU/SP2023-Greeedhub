...
class Mt3dms2(BaseModel):
    ...
    @staticmethod
    def load(f, modflowmodel, version='mt3dms', exe_name='mt3dms.exe',
             verbose=False, model_ws='.', load_only=None):
        """
        ...
        modflowmodel : flopy.modflow.Modflow
            The flopy MODFLOW model that corresponds to this MT3D model
        ...
        >>> import flopy
        >>> mt = flopy.modflow.mt.Mt3dms2.load(f)
        ...
        if verbose:
            sys.stdout.write('\nCreating new model with name: {}\n{}\n\n'.
                             format(modelname, 50 * '-'))
        mt = Mt3dms2(modflowmodel=modflowmodel, modelname=modelname,
