...
JUNCTION_ANTINOMIES_CAUSAL_OPPOSITE_EFFECT = script("E:.-wo.-k.u.-'")
JUNCTION_ANTINOMIES_CAUSAL_REDUCE_EFFECT = script("E:.-wa.-k.u.-'")
JUNCTION_ANTINOMIES_CAUSAL_INCREASE_EFFECT = script("E:.-we.-k.u.-'")
