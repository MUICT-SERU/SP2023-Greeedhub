...
class ModflowSfr2(Package):
    ...
    istcsb1 : integer
        ...
        If ISTCB1 = 0, leakage values will not be printed or saved. Printing to the listing file (ISTCB1 < 0) is not supported.
    istcsb2 : integer
    ...
    def __init__(self, model, nstrm=2, nss=1, nsfrpar=0, nparseg=0, const=128390.4, dleak=0.0001, istcb1=53, istcb2=66,
                 isfropt=0,
        ...
        Package.__init__(self, model, extension, name=name,
                         unit_number=units)  # Call ancestor's init to set self.parent, extension, name, and unit number
