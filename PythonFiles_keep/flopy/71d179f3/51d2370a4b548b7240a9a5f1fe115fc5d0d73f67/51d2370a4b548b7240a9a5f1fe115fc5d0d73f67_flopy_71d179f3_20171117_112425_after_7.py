...
class ModflowGwfchd(mfpackage.MFPackage):
    ...
    obs_filerecord : [(obs6 : keyword), (filein : keyword), (obs6_filename : string)]
        ...
        obs6_filename : name of input file to define observations for the constant-head package. See the ``Observation utility'' section for instructions for preparing observation input files. Table obstype lists observation type(s) supported by the constant-head package.
    ...
    periodrecarray : [(cellid : integer), (head : double), (aux : double), (boundname : string)]
    ...
    def __init__(self, model, add_to_package_list=True, auxiliary=None, auxmultname=None, boundnames=None,
                 ...
                 parent_file=None):
        super(ModflowGwfchd, self).__init__(model, "chd", fname, pname, add_to_package_list, parent_file)        
