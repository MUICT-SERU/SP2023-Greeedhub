...
class ModflowGwfchd(mfpackage.MFPackage):
    ...
    print_input : boolean
        * print_input (boolean) keyword to indicate that the list of constant-
        head information will be written to the listing file immediately after
        it is read.
    print_flows : boolean
    ...
    obs_filerecord : [obs6_filename]
        * obs6_filename (string) name of input file to define observations for
        ...
        obstype lists observation type(s) supported by the constant-
        head package.
    maxbound : integer
    ...
    periodrecarray : [cellid, head, aux, boundname]
        ...
        * aux (double) represents the values of the auxiliary variables for
        ...
        the auxiliary variables specified in the OPTIONS block. If the package
