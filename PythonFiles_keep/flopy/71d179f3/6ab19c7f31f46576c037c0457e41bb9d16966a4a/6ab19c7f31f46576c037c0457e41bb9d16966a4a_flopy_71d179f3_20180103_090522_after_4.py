...
class ModflowGwfdis(mfpackage.MFPackage):
    ...
    yorigin : double
        * yorigin (double) y-position of the lower-left corner of the model
        grid. If not specified, then a default value equal to zero is used. The
        value for yorigin does not affect the model simulation, but it
    ...
    angrot : double
        * angrot (double) counter-clockwise rotation angle (in degrees) of the
        ...
        value of 0.0 is assigned. The value for angrot does not affect
