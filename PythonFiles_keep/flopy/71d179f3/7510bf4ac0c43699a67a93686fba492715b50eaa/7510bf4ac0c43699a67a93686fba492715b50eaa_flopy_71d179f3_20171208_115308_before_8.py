...
class ModflowGwfevt(mfpackage.MFPackage):
    ...
    periodrecarray : [(cellid : (integer, ...)), (surface : double), (rate : double), (depth : double), (pxdp : double), (petm : double), (petm0 : double), (aux : double), (boundname : string)]
        ...
        pxdp : is the proportion of the ET extinction depth at the bottom of a segment (dimensionless). A time-series name may be specified.
        petm : is the proportion of the maximum ET flux rate at the bottom of a segment (dimensionless). A time-series name may be specified.
        petm0 : is the proportion of the maximum ET flux rate that will apply when head is at or above the ET surface (dimensionless). PETM0 is read only when the SURF\_RATE\_SPECIFIED option is used. A time-series name may be specified.
    ...
    def __init__(self, model, add_to_package_list=True, fixed_cell=None, auxiliary=None, auxmultname=None,
                 ...
                 nseg=None, periodrecarray=None, fname=None, pname=None, parent_file=None):
        super(ModflowGwfevt, self).__init__(model, "evt", fname, pname, add_to_package_list, parent_file)        
        ...
        self.surf_rate_specified = self.build_mfdata("surf_rate_specified", surf_rate_specified)
