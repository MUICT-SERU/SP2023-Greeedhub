...
class ModpathSim(Package):
    ...
    def __init__(self, model, mp_name_file = 'mp.nam', mp_list_file = 'mp.list',
        ...
        self.heading2 = '#'
        self.mp_name_file = '{}.{}'.format(model.get_name(), 'mpnam') 
        self.mp_list_file = '{}.{}'.format(model.get_name(), 'mplst')
        ...
        self.endpoint_file = '{}.{}'.format(model.get_name(), 'mpend')
        self.pathline_file = '{}.{}'.format(model.get_name(), 'mppth')
        self.time_ser_file = '{}.{}'.format(model.get_name(), 'mp.tim_ser')
        self.advobs_file = '{}.{}'.format(model.get_name(), '.mp.advobs')
