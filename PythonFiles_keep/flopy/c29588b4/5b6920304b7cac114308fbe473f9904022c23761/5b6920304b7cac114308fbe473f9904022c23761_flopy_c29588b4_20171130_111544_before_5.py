...
lpf = flopy.modflow.ModflowLpf(ml, hk=2., vka=2.0, vkcb=0, laytyp=0, layavg=0)
...
ax.text(-0.075, 1.05, 'A', transform=ax.transAxes, va='center', ha='center',
        size='8')
...
ax.text(40, -22, 'groundwater flow velocity=0.125 m/d', ha='center', size=7)
ax.set_ylabel('Elevation, in meters')

ax = fig.add_subplot(212)
ax.text(-0.075, 1.05, 'B', transform=ax.transAxes, va='center', ha='center',
        size='8')
